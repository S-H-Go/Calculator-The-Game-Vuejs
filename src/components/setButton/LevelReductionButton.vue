...
<template>
  <button
    class="button color-button-6c96b6" @touchstart="continuousReduction('touchstart')" @touchcancel="stopReduction()"
    @touchend="stopReduction()" @mousedown="continuousReduction('mousedown')" @mouseup="stopReduction()"
    @mouseleave="stopReduction()"
  >
    -
  </button>
</template>
